...
declare -A DepReason=(
    ...
    ["curl"]="required for fetching Arch Linux news feed & updating betterfox."
...
MENU_ITEMS=(
    ...
    "Update mirror list|reflector|util:04-Mirrorlist"
    "Upgrade official packages||util:05-OfficialUpgrade"
    "Upgrade AUR packages|yay|util:06-AURupgrade"
    "Check for orphaned packages||util:07-OrphanedCheck"
    "Clean packages cache|pacman-contrib|util:08-CleanPackagesCache"
    "Clean temporary files||util:09-CleanTempFiles"
    "Clean log files||util:10-CleanLogFiles"
    "Check disk usage|ncdu|util:11-DiskUsage"
    ...
    "Export package list||util:15-ExportPackageList"
    "Update unstowed dotfiles||util:16-UpdateUnstowed"
    "Sync Github repositories||util:17-SyncGitRepos"
    "Reboot||shell:reboot"
    "Quit||exit"
)
